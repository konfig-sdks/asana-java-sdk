...
public class AttachmentResponseAllOf {
  ...
  **/
  ...
  public AttachmentResponseAllOf parent(TaskCompact parent) {
  ...
  **/
   ...
   * @return the AttachmentResponseAllOf instance itself
   */
  public AttachmentResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createdAt, attachmentResponseAllOf.createdAt) &&
        Objects.equals(this.downloadUrl, attachmentResponseAllOf.downloadUrl) &&
        Objects.equals(this.permanentUrl, attachmentResponseAllOf.permanentUrl) &&
        Objects.equals(this.host, attachmentResponseAllOf.host) &&
        Objects.equals(this.parent, attachmentResponseAllOf.parent) &&
        Objects.equals(this.size, attachmentResponseAllOf.size) &&
        Objects.equals(this.viewUrl, attachmentResponseAllOf.viewUrl) &&
        Objects.equals(this.connectedToApp, attachmentResponseAllOf.connectedToApp)&&
        Objects.equals(this.additionalProperties, attachmentResponseAllOf.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createdAt, downloadUrl, permanentUrl, host, parent, size, viewUrl, connectedToApp, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AttachmentResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AttachmentResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AttachmentResponseAllOf is not found in the empty JSON string", AttachmentResponseAllOf.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AttachmentResponseAllOf>() {
           ...
           public AttachmentResponseAllOf read(JsonReader in) throws IOException {
             ...
             AttachmentResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
