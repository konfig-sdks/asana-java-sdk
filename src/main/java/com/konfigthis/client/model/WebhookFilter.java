 ...
 */
@ApiModel(description = "A WebhookFilter can be passed on creation of a webhook in order to filter the types of actions that trigger delivery of an [event](https://developers.asana.com/reference/rest-api-reference)")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class WebhookFilter {
  ...
  **/
   ...
   * @return the WebhookFilter instance itself
   */
  public WebhookFilter putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.resourceType, webhookFilter.resourceType) &&
        ...
        Objects.equals(this.additionalProperties, webhookFilter.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookFilter
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookFilter.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<WebhookFilter>() {
           ...
           public WebhookFilter read(JsonReader in) throws IOException {
             ...
             WebhookFilter instance = thisAdapter.fromJsonTree(jsonObj);
