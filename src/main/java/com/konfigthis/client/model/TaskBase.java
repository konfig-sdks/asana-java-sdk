...
public class TaskBase {
  ...
  **/
  ...
  public TaskBase createdBy(TaskCompactAllOfCreatedBy createdBy) {
  ...
  **/
   ...
   * @return the TaskBase instance itself
   */
  public TaskBase putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.gid, taskBase.gid) &&
        ...
        Objects.equals(this.additionalProperties, taskBase.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to TaskBase
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TaskBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TaskBase>() {
           ...
           public TaskBase read(JsonReader in) throws IOException {
             ...
             TaskBase instance = thisAdapter.fromJsonTree(jsonObj);
