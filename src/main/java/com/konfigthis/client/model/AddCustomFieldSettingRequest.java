...
public class AddCustomFieldSettingRequest {
  ...
  **/
  ...
  @ApiModelProperty(example = "14916", required = true, value = "The custom field to associate with this container.")
  ...
  **/
  ...
  @ApiModelProperty(example = "true", value = "Whether this field should be considered important to this container (for instance, to display in the list view of items in the container).")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1331", value = "A gid of a Custom Field Setting on this container, before which the new Custom Field Setting will be added.  `insert_before` and `insert_after` parameters cannot both be specified.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1331", value = "A gid of a Custom Field Setting on this container, after which the new Custom Field Setting will be added.  `insert_before` and `insert_after` parameters cannot both be specified.")
   ...
   * @return the AddCustomFieldSettingRequest instance itself
   */
  public AddCustomFieldSettingRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.customField, addCustomFieldSettingRequest.customField) &&
        ...
        Objects.equals(this.additionalProperties, addCustomFieldSettingRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(customField, isImportant, insertBefore, insertAfter, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddCustomFieldSettingRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddCustomFieldSettingRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AddCustomFieldSettingRequest>() {
           ...
           public AddCustomFieldSettingRequest read(JsonReader in) throws IOException {
             ...
             AddCustomFieldSettingRequest instance = thisAdapter.fromJsonTree(jsonObj);
