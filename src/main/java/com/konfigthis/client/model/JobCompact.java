...
public class JobCompact {
  ...
  **/
   ...
   * @return the JobCompact instance itself
   */
  public JobCompact putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.gid, jobCompact.gid) &&
        ...
        Objects.equals(this.additionalProperties, jobCompact.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gid, resourceType, resourceSubtype, status, newProject, newTask, newProjectTemplate, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to JobCompact
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!JobCompact.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<JobCompact>() {
           ...
           public JobCompact read(JsonReader in) throws IOException {
             ...
             JobCompact instance = thisAdapter.fromJsonTree(jsonObj);
