 ...
 */
@ApiModel(description = "Custom Fields store the metadata that is used in order to add user-specified information to tasks in Asana. Be sure to reference the [custom fields](https://developers.asana.com/reference/rest-api-reference) developer documentation for more information about how custom fields relate to various resources in Asana.  Users in Asana can [lock custom fields](https://asana.com/guide/help/premium/custom-fields#gl-lock-fields), which will make them read-only when accessed by other users. Attempting to edit a locked custom field will return HTTP error code `403 Forbidden`.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class CustomFieldCompactAllOf {
 ...
 public enum RepresentationTypeEnum {
  ...
  public CustomFieldCompactAllOf() {
  }
  ...
  public CustomFieldCompactAllOf name(String name) {
  ...
  **/
  ...
  public CustomFieldCompactAllOf enumOptions(List<EnumOption> enumOptions) {
  ...
  public CustomFieldCompactAllOf addEnumOptionsItem(EnumOption enumOptionsItem) {
  ...
  **/
  ...
  public CustomFieldCompactAllOf idPrefix(String idPrefix) {
  ...
  **/
  ...
  public CustomFieldCompactAllOf isFormulaField(Boolean isFormulaField) {
  ...
  **/
  ...
  public CustomFieldCompactAllOf dateValue(CustomFieldCompactAllOfDateValue dateValue) {
  ...
  **/
  ...
  public CustomFieldCompactAllOf enumValue(EnumOption enumValue) {
  ...
  **/
  ...
  public CustomFieldCompactAllOf multiEnumValues(List<EnumOption> multiEnumValues) {
  ...
  public CustomFieldCompactAllOf addMultiEnumValuesItem(EnumOption multiEnumValuesItem) {
  ...
  **/
  ...
  public CustomFieldCompactAllOf numberValue(Double numberValue) {
  ...
  public CustomFieldCompactAllOf numberValue(Integer numberValue) {
  ...
  **/
  ...
  public CustomFieldCompactAllOf textValue(String textValue) {
  ...
  **/
   ...
   * @return the CustomFieldCompactAllOf instance itself
   */
  public CustomFieldCompactAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CustomFieldCompactAllOf customFieldCompactAllOf = (CustomFieldCompactAllOf) o;
    return Objects.equals(this.name, customFieldCompactAllOf.name) &&
        Objects.equals(this.resourceSubtype, customFieldCompactAllOf.resourceSubtype) &&
        Objects.equals(this.type, customFieldCompactAllOf.type) &&
        Objects.equals(this.enumOptions, customFieldCompactAllOf.enumOptions) &&
        Objects.equals(this.enabled, customFieldCompactAllOf.enabled) &&
        Objects.equals(this.representationType, customFieldCompactAllOf.representationType) &&
        Objects.equals(this.idPrefix, customFieldCompactAllOf.idPrefix) &&
        Objects.equals(this.isFormulaField, customFieldCompactAllOf.isFormulaField) &&
        Objects.equals(this.dateValue, customFieldCompactAllOf.dateValue) &&
        Objects.equals(this.enumValue, customFieldCompactAllOf.enumValue) &&
        Objects.equals(this.multiEnumValues, customFieldCompactAllOf.multiEnumValues) &&
        Objects.equals(this.numberValue, customFieldCompactAllOf.numberValue) &&
        Objects.equals(this.textValue, customFieldCompactAllOf.textValue) &&
        Objects.equals(this.displayValue, customFieldCompactAllOf.displayValue)&&
        Objects.equals(this.additionalProperties, customFieldCompactAllOf.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, resourceSubtype, type, enumOptions, enabled, representationType, idPrefix, isFormulaField, dateValue, enumValue, multiEnumValues, numberValue, textValue, displayValue, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CustomFieldCompactAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CustomFieldCompactAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CustomFieldCompactAllOf is not found in the empty JSON string", CustomFieldCompactAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CustomFieldCompactAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CustomFieldCompactAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CustomFieldCompactAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CustomFieldCompactAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<CustomFieldCompactAllOf>() {
           @Override
           public void write(JsonWriter out, CustomFieldCompactAllOf value) throws IOException {
           ...
           @Override
           public CustomFieldCompactAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CustomFieldCompactAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CustomFieldCompactAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CustomFieldCompactAllOf
  * @throws IOException if the JSON string is invalid with respect to CustomFieldCompactAllOf
  */
  public static CustomFieldCompactAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CustomFieldCompactAllOf.class);
  }

 /**
  * Convert an instance of CustomFieldCompactAllOf to an JSON string
  *
  * @return JSON string
  */
