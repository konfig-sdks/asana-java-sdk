...
import com.konfigthis.client.model.BatchRequestAction;
 ...
 */
@ApiModel(description = "A request object for use in a batch request.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class BatchRequest {
  ...
  **/
   ...
   * @return the BatchRequest instance itself
   */
  public BatchRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.actions, batchRequest.actions)&&
        Objects.equals(this.additionalProperties, batchRequest.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to BatchRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BatchRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("actions") != null && !jsonObj.get("actions").isJsonNull()) {
        ...
        if (jsonArrayactions != null) {
          ...
          for (int i = 0; i < jsonArrayactions.size(); i++) {
            BatchRequestAction.validateJsonObject(jsonArrayactions.get(i).getAsJsonObject());
          };
        }
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BatchRequest>() {
           ...
           public BatchRequest read(JsonReader in) throws IOException {
             ...
             BatchRequest instance = thisAdapter.fromJsonTree(jsonObj);
