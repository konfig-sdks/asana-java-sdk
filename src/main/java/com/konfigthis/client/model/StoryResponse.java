...
public class StoryResponse {
  ...
  **/
  ...
  public StoryResponse target(TaskCompact target) {
  ...
  **/
   ...
   * @return the StoryResponse instance itself
   */
  public StoryResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.gid, storyResponse.gid) &&
        ...
        Objects.equals(this.additionalProperties, storyResponse.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to StoryResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!StoryResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<StoryResponse>() {
           ...
           public StoryResponse read(JsonReader in) throws IOException {
             ...
             StoryResponse instance = thisAdapter.fromJsonTree(jsonObj);
