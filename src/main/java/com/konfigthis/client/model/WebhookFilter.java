 ...
 */
@ApiModel(description = "A WebhookFilter can be passed on creation of a webhook in order to filter the types of actions that trigger delivery of an [event](https://raw.githubusercontent.com)")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
