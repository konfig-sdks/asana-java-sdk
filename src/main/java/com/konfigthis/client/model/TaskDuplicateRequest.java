...
public class TaskDuplicateRequest {
  ...
  **/
  ...
  @ApiModelProperty(example = "New Task Name", value = "The name of the new task.")
  ...
  public TaskDuplicateRequest include(String include) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "[\"notes,assignee,subtasks,attachments,tags,followers,projects,dates,dependencies,parent\"]", value = "A comma-separated list of fields that will be duplicated to the new task. ##### Fields - assignee - attachments - dates - dependencies - followers - notes - parent - projects - subtasks - tags")
   ...
   * @return the TaskDuplicateRequest instance itself
   */
  public TaskDuplicateRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, taskDuplicateRequest.name) &&
        ...
        Objects.equals(this.additionalProperties, taskDuplicateRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, include, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to TaskDuplicateRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TaskDuplicateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TaskDuplicateRequest>() {
           ...
           public TaskDuplicateRequest read(JsonReader in) throws IOException {
             ...
             TaskDuplicateRequest instance = thisAdapter.fromJsonTree(jsonObj);
