...
public class GoalBase {
  ...
  **/
   ...
   * @return the GoalBase instance itself
   */
  public GoalBase putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.gid, goalBase.gid) &&
        ...
        Objects.equals(this.additionalProperties, goalBase.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(gid, resourceType, name, htmlNotes, notes, dueOn, startOn, isWorkspaceLevel, liked, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GoalBase
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GoalBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GoalBase>() {
           ...
           public GoalBase read(JsonReader in) throws IOException {
             ...
             GoalBase instance = thisAdapter.fromJsonTree(jsonObj);
