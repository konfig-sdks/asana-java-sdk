 ...
 */
@ApiModel(description = "Webhook objects represent the state of an active subscription for a server to be updated with information from Asana. This schema represents the subscription itself, not the objects that are sent to the server. For information on those please refer to the [event](https://developers.asana.com/reference/rest-api-reference) schema.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
