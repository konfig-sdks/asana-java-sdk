...
import com.konfigthis.client.model.BatchRequestActionOptions;
 ...
 */
@ApiModel(description = "An action object for use in a batch request.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class BatchRequestAction {
  ...
  **/
  ...
  @ApiModelProperty(example = "/tasks/123", required = true, value = "The path of the desired endpoint relative to the API’s base URL. Query parameters are not accepted here; put them in `data` instead.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "GET", required = true, value = "The HTTP method you wish to emulate for the action.")
  ...
  **/
  ...
  @ApiModelProperty(example = "{\"assignee\":\"me\",\"workspace\":\"1337\"}", value = "For `GET` requests, this should be a map of query parameters you would have normally passed in the URL. Options and pagination are not accepted here; put them in `options` instead. For `POST`, `PATCH`, and `PUT` methods, this should be the content you would have normally put in the data field of the body.")
  ...
  **/
   ...
   * @return the BatchRequestAction instance itself
   */
  public BatchRequestAction putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.relativePath, batchRequestAction.relativePath) &&
        ...
        Objects.equals(this.additionalProperties, batchRequestAction.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(relativePath, method, data, options, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to BatchRequestAction
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BatchRequestAction.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("options") != null && !jsonObj.get("options").isJsonNull()) {
        BatchRequestActionOptions.validateJsonObject(jsonObj.getAsJsonObject("options"));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BatchRequestAction>() {
           ...
           public BatchRequestAction read(JsonReader in) throws IOException {
             ...
             BatchRequestAction instance = thisAdapter.fromJsonTree(jsonObj);
