 ...
 */
@ApiModel(description = "An object to represent a user's like.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Like {
  ...
  **/
  ...
  @ApiModelProperty(example = "12345", value = "Globally unique identifier of the object, as a string.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(gid, user, additionalProperties);
  }
