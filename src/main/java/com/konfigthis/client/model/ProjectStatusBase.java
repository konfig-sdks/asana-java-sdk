...
public class ProjectStatusBase {
  ...
  **/
   ...
   * @return the ProjectStatusBase instance itself
   */
  public ProjectStatusBase putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.gid, projectStatusBase.gid) &&
        ...
        Objects.equals(this.additionalProperties, projectStatusBase.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gid, resourceType, title, text, htmlText, color, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProjectStatusBase
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProjectStatusBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ProjectStatusBase>() {
           ...
           public ProjectStatusBase read(JsonReader in) throws IOException {
             ...
             ProjectStatusBase instance = thisAdapter.fromJsonTree(jsonObj);
