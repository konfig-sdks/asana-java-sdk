...
public class ProjectBase {
  ...
  **/
  ...
  public ProjectBase defaultAccessLevel(DefaultAccessLevelEnum defaultAccessLevel) {
  ...
  **/
  ...
  public ProjectBase minimumAccessLevelForCustomization(MinimumAccessLevelForCustomizationEnum minimumAccessLevelForCustomization) {
  ...
  **/
  ...
  public ProjectBase minimumAccessLevelForSharing(MinimumAccessLevelForSharingEnum minimumAccessLevelForSharing) {
  ...
  **/
   ...
   * @return the ProjectBase instance itself
   */
  public ProjectBase putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.gid, projectBase.gid) &&
        ...
        Objects.equals(this.additionalProperties, projectBase.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProjectBase
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProjectBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ProjectBase>() {
           ...
           public ProjectBase read(JsonReader in) throws IOException {
             ...
             ProjectBase instance = thisAdapter.fromJsonTree(jsonObj);
