...
public class ProjectBriefBase {
  ...
  **/
   ...
   * @return the ProjectBriefBase instance itself
   */
  public ProjectBriefBase putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.gid, projectBriefBase.gid) &&
        ...
        Objects.equals(this.additionalProperties, projectBriefBase.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gid, resourceType, title, htmlText, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProjectBriefBase
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProjectBriefBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProjectBriefBase is not found in the empty JSON string", ProjectBriefBase.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectBriefBase.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectBriefBase' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectBriefBase> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectBriefBase.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectBriefBase>() {
           @Override
           public void write(JsonWriter out, ProjectBriefBase value) throws IOException {
           ...
           @Override
           public ProjectBriefBase read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ProjectBriefBase instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ProjectBriefBase given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProjectBriefBase
  * @throws IOException if the JSON string is invalid with respect to ProjectBriefBase
  */
  public static ProjectBriefBase fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectBriefBase.class);
  }

 /**
  * Convert an instance of ProjectBriefBase to an JSON string
  *
  * @return JSON string
  */
