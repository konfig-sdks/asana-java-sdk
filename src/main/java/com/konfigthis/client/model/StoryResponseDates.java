 ...
 * *Conditional*
 */
@ApiModel(description = "*Conditional*")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class StoryResponseDates {
  ...
  **/
  ...
  @ApiModelProperty(example = "Fri Sep 13 17:00:00 PDT 2019", value = "The day on which work for this goal begins, or null if the goal has no start date. This takes a date with `YYYY-MM-DD` format, and cannot be set unless there is an accompanying due date.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2019-09-15T02:06:58.158Z", value = "The UTC date and time on which this task is due, or null if the task has no due time. This takes an ISO 8601 date string in UTC and should not be used together with `due_on`.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Sat Sep 14 17:00:00 PDT 2019", value = "The localized day on which this goal is due. This takes a date with format `YYYY-MM-DD`.")
   ...
   * @return the StoryResponseDates instance itself
   */
  public StoryResponseDates putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.startOn, storyResponseDates.startOn) &&
        ...
        Objects.equals(this.additionalProperties, storyResponseDates.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(startOn, dueAt, dueOn, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to StoryResponseDates
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!StoryResponseDates.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<StoryResponseDates>() {
           ...
           public StoryResponseDates read(JsonReader in) throws IOException {
             ...
             StoryResponseDates instance = thisAdapter.fromJsonTree(jsonObj);
