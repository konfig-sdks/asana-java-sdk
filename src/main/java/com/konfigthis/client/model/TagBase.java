...
public class TagBase {
  ...
  **/
   ...
   * @return the TagBase instance itself
   */
  public TagBase putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.gid, tagBase.gid) &&
        ...
        Objects.equals(this.additionalProperties, tagBase.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(gid, resourceType, name, color, notes, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TagBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TagBase>() {
           ...
           public TagBase read(JsonReader in) throws IOException {
             ...
             TagBase instance = thisAdapter.fromJsonTree(jsonObj);
