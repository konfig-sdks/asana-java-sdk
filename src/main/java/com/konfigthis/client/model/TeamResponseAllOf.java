...
public class TeamResponseAllOf {
 ...
 public enum TeamMemberRemovalAccessLevelEnum {
  ...
  public TeamResponseAllOf description(String description) {
  ...
  **/
  ...
  public TeamResponseAllOf htmlDescription(String htmlDescription) {
  ...
  **/
  ...
  public TeamResponseAllOf organization(WorkspaceCompact organization) {
  ...
  **/
  ...
  public TeamResponseAllOf visibility(VisibilityEnum visibility) {
  ...
  **/
   ...
   * @return the TeamResponseAllOf instance itself
   */
  public TeamResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TeamResponseAllOf teamResponseAllOf = (TeamResponseAllOf) o;
    return Objects.equals(this.description, teamResponseAllOf.description) &&
        Objects.equals(this.htmlDescription, teamResponseAllOf.htmlDescription) &&
        Objects.equals(this.organization, teamResponseAllOf.organization) &&
        Objects.equals(this.permalinkUrl, teamResponseAllOf.permalinkUrl) &&
        Objects.equals(this.visibility, teamResponseAllOf.visibility) &&
        Objects.equals(this.editTeamNameOrDescriptionAccessLevel, teamResponseAllOf.editTeamNameOrDescriptionAccessLevel) &&
        Objects.equals(this.editTeamVisibilityOrTrashTeamAccessLevel, teamResponseAllOf.editTeamVisibilityOrTrashTeamAccessLevel) &&
        Objects.equals(this.memberInviteManagementAccessLevel, teamResponseAllOf.memberInviteManagementAccessLevel) &&
        Objects.equals(this.guestInviteManagementAccessLevel, teamResponseAllOf.guestInviteManagementAccessLevel) &&
        Objects.equals(this.joinRequestManagementAccessLevel, teamResponseAllOf.joinRequestManagementAccessLevel) &&
        Objects.equals(this.teamMemberRemovalAccessLevel, teamResponseAllOf.teamMemberRemovalAccessLevel)&&
        Objects.equals(this.additionalProperties, teamResponseAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, htmlDescription, organization, permalinkUrl, visibility, editTeamNameOrDescriptionAccessLevel, editTeamVisibilityOrTrashTeamAccessLevel, memberInviteManagementAccessLevel, guestInviteManagementAccessLevel, joinRequestManagementAccessLevel, teamMemberRemovalAccessLevel, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to TeamResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TeamResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TeamResponseAllOf is not found in the empty JSON string", TeamResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TeamResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TeamResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TeamResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TeamResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<TeamResponseAllOf>() {
           @Override
           public void write(JsonWriter out, TeamResponseAllOf value) throws IOException {
           ...
           @Override
           public TeamResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TeamResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TeamResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TeamResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to TeamResponseAllOf
  */
  public static TeamResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TeamResponseAllOf.class);
  }

 /**
  * Convert an instance of TeamResponseAllOf to an JSON string
  *
  * @return JSON string
  */
