...
public class GoalMembershipBase {
  ...
  **/
  ...
  public GoalMembershipBase resourceType(String resourceType) {
  ...
  **/
  ...
  public GoalMembershipBase member(MemberCompact member) {
  ...
  **/
  ...
  public GoalMembershipBase parent(GoalCompact parent) {
  ...
  **/
  ...
  public GoalMembershipBase role(RoleEnum role) {
  ...
  **/
  ...
  public GoalMembershipBase goal(GoalCompact goal) {
  ...
  **/
   ...
   * @return the GoalMembershipBase instance itself
   */
  public GoalMembershipBase putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.gid, goalMembershipBase.gid) &&
        ...
        Objects.equals(this.additionalProperties, goalMembershipBase.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gid, resourceType, resourceSubtype, member, parent, role, goal, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GoalMembershipBase
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GoalMembershipBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoalMembershipBase is not found in the empty JSON string", GoalMembershipBase.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoalMembershipBase.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoalMembershipBase' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoalMembershipBase> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoalMembershipBase.class));

       return (TypeAdapter<T>) new TypeAdapter<GoalMembershipBase>() {
           @Override
           public void write(JsonWriter out, GoalMembershipBase value) throws IOException {
           ...
           @Override
           public GoalMembershipBase read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GoalMembershipBase instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GoalMembershipBase given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GoalMembershipBase
  * @throws IOException if the JSON string is invalid with respect to GoalMembershipBase
  */
  public static GoalMembershipBase fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoalMembershipBase.class);
  }

 /**
  * Convert an instance of GoalMembershipBase to an JSON string
  *
  * @return JSON string
  */
