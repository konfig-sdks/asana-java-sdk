 ...
 */
@ApiModel(description = "A *goal relationship* is an object representing the relationship between a goal and another goal, a project, a task, or a portfolio.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class GoalRelationshipCompactAllOf {
  /**
 ...
 public enum ResourceSubtypeEnum {
  ...
  public GoalRelationshipCompactAllOf() {
  }
  ...
  **/
  ...
  public GoalRelationshipCompactAllOf supportingResource(ProjectCompact supportingResource) {
  ...
  **/
  ...
  public GoalRelationshipCompactAllOf contributionWeight(Double contributionWeight) {
  ...
  public GoalRelationshipCompactAllOf contributionWeight(Integer contributionWeight) {
  ...
  **/
   ...
   * @return the GoalRelationshipCompactAllOf instance itself
   */
  public GoalRelationshipCompactAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    GoalRelationshipCompactAllOf goalRelationshipCompactAllOf = (GoalRelationshipCompactAllOf) o;
    return Objects.equals(this.resourceSubtype, goalRelationshipCompactAllOf.resourceSubtype) &&
        Objects.equals(this.supportingResource, goalRelationshipCompactAllOf.supportingResource) &&
        Objects.equals(this.contributionWeight, goalRelationshipCompactAllOf.contributionWeight)&&
        Objects.equals(this.additionalProperties, goalRelationshipCompactAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(resourceSubtype, supportingResource, contributionWeight, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GoalRelationshipCompactAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GoalRelationshipCompactAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoalRelationshipCompactAllOf is not found in the empty JSON string", GoalRelationshipCompactAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoalRelationshipCompactAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoalRelationshipCompactAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoalRelationshipCompactAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoalRelationshipCompactAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<GoalRelationshipCompactAllOf>() {
           @Override
           public void write(JsonWriter out, GoalRelationshipCompactAllOf value) throws IOException {
           ...
           @Override
           public GoalRelationshipCompactAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GoalRelationshipCompactAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GoalRelationshipCompactAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GoalRelationshipCompactAllOf
  * @throws IOException if the JSON string is invalid with respect to GoalRelationshipCompactAllOf
  */
  public static GoalRelationshipCompactAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoalRelationshipCompactAllOf.class);
  }

 /**
  * Convert an instance of GoalRelationshipCompactAllOf to an JSON string
  *
  * @return JSON string
  */
