...
|------------- | ------------- | -------------|
| [**getRecord**](UserTaskListsApi.md#getRecord) | **GET** /user_task_lists/{user_task_list_gid} | Get a user task list |
| [**getUserTaskList**](UserTaskListsApi.md#getUserTaskList) | **GET** /users/{user_gid}/user_task_list | Get a user&#39;s task list |


<a name="getRecord"></a>
# **getRecord**
> UserTaskListsGetRecordResponse getRecord(userTaskListGid).optPretty(optPretty).optFields(optFields).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      UserTaskListsGetRecordResponse result = client
              .userTaskLists
              .getRecord(userTaskListGid)
              .optPretty(optPretty)
              .optFields(optFields)
              .execute();
      ...
      System.err.println("Exception when calling UserTaskListsApi#getRecord");
    ...
    try {
      ApiResponse<UserTaskListsGetRecordResponse> response = client
              .userTaskLists
              .getRecord(userTaskListGid)
              .optPretty(optPretty)
              .optFields(optFields)
...
| **optFields** | [**List&lt;String&gt;**](String.md)| This endpoint returns a compact resource, which excludes some properties by default. To include those optional properties, set this query parameter to a comma-separated list of the properties you wish to include. | [optional] [enum: name, owner, workspace] |

### Return type

[**UserTaskListsGetRecordResponse**](UserTaskListsGetRecordResponse.md)
...
# **getUserTaskList**
> UserTaskListsGetUserTaskListResponse getUserTaskList(userGid, workspace).optPretty(optPretty).optFields(optFields).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    String workspace = "1234"; // The workspace in which to get the user task list.
    Boolean optPretty = true; // Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.
    List<String> optFields = Arrays.asList(); // This endpoint returns a compact resource, which excludes some properties by default. To include those optional properties, set this query parameter to a comma-separated list of the properties you wish to include.
    try {
      UserTaskListsGetUserTaskListResponse result = client
              .userTaskLists
              .getUserTaskList(userGid, workspace)
              .optPretty(optPretty)
              .optFields(optFields)
              .execute();
      System.out.println(result);
    ...
    // Use .executeWithHttpInfo() to retrieve HTTP Status Code, Headers and Request
    try {
      ApiResponse<UserTaskListsGetUserTaskListResponse> response = client
              .userTaskLists
              .getUserTaskList(userGid, workspace)
              .optPretty(optPretty)
              .optFields(optFields)
...
[**UserTaskListsGetUserTaskListResponse**](UserTaskListsGetUserTaskListResponse.md)
