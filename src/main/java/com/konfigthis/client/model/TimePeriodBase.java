...
public class TimePeriodBase {
  ...
  **/
   ...
   * @return the TimePeriodBase instance itself
   */
  public TimePeriodBase putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.gid, timePeriodBase.gid) &&
        ...
        Objects.equals(this.additionalProperties, timePeriodBase.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gid, resourceType, endOn, startOn, period, displayName, parent, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to TimePeriodBase
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TimePeriodBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TimePeriodBase>() {
           ...
           public TimePeriodBase read(JsonReader in) throws IOException {
             ...
             TimePeriodBase instance = thisAdapter.fromJsonTree(jsonObj);
