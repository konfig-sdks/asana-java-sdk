...
public class GoalBaseAllOf {
  ...
  public GoalBaseAllOf() {
  }

  public GoalBaseAllOf name(String name) {
  ...
  **/
  ...
  public GoalBaseAllOf htmlNotes(String htmlNotes) {
  ...
  **/
  ...
  public GoalBaseAllOf notes(String notes) {
  ...
  **/
  ...
  public GoalBaseAllOf dueOn(String dueOn) {
  ...
  **/
  ...
  public GoalBaseAllOf startOn(String startOn) {
  ...
  **/
  ...
  public GoalBaseAllOf isWorkspaceLevel(Boolean isWorkspaceLevel) {
  ...
  **/
  ...
  public GoalBaseAllOf liked(Boolean liked) {
  ...
  **/
   ...
   * @return the GoalBaseAllOf instance itself
   */
  public GoalBaseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    GoalBaseAllOf goalBaseAllOf = (GoalBaseAllOf) o;
    return Objects.equals(this.name, goalBaseAllOf.name) &&
        Objects.equals(this.htmlNotes, goalBaseAllOf.htmlNotes) &&
        Objects.equals(this.notes, goalBaseAllOf.notes) &&
        Objects.equals(this.dueOn, goalBaseAllOf.dueOn) &&
        Objects.equals(this.startOn, goalBaseAllOf.startOn) &&
        Objects.equals(this.isWorkspaceLevel, goalBaseAllOf.isWorkspaceLevel) &&
        Objects.equals(this.liked, goalBaseAllOf.liked)&&
        Objects.equals(this.additionalProperties, goalBaseAllOf.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, htmlNotes, notes, dueOn, startOn, isWorkspaceLevel, liked, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GoalBaseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GoalBaseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoalBaseAllOf is not found in the empty JSON string", GoalBaseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoalBaseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoalBaseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoalBaseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoalBaseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<GoalBaseAllOf>() {
           @Override
           public void write(JsonWriter out, GoalBaseAllOf value) throws IOException {
           ...
           @Override
           public GoalBaseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GoalBaseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GoalBaseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GoalBaseAllOf
  * @throws IOException if the JSON string is invalid with respect to GoalBaseAllOf
  */
  public static GoalBaseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoalBaseAllOf.class);
  }

 /**
  * Convert an instance of GoalBaseAllOf to an JSON string
  *
  * @return JSON string
  */
