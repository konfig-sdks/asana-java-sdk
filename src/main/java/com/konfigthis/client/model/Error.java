...
public class Error {
  ...
  **/
  ...
  @ApiModelProperty(example = "project: Missing input", value = "Message providing more detail about the error that occurred, if available.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "For more information on API status codes and how to handle them, read the docs on errors: https://asana.github.io/developer-docs/#errors'", value = "Additional information directing developers to resources on how to address and fix the problem, if available.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "6 sad squid snuggle softly", value = "*500 errors only*. A unique error phrase which can be used when contacting developer support to help identify the exact occurrence of the problem in Asana’s logs.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(message, help, phrase, additionalProperties);
  }
